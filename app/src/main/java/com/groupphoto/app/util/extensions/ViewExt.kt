...
import com.groupphoto.app.util.animOnFinish
...
fun View.animateBackgroundColor(
    ...
    val colorToRes = this.context.getCompatColor(colorToResId)
    val colorFrom = this.context.getCompatColor(colorFromRes)
...
fun ImageView.loadImageWithCorners(url: String?, corner: Int = 24) {
    Glide.with(this)
        .load(url)
        .placeholder(R.color.LinkWater)
